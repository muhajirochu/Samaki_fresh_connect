...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // The url_launcher plugin's `launchUrl` method is forwarded
      // to the platform channel as a method named `launchUrl` (the
      // legacy `launch` method is also kept). Either is acceptable.
      final launchCall = launchCalls.firstWhere(
        (c) => c.method == 'launchUrl' || c.method == 'launch',
